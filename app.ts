...
const united_sans_reg_heavy = font2base64.encodeToDataUrlSync('fonts/UnitedSansReg-Heavy.woff')

const united_sans_reg_black = font2base64.encodeToDataUrlSync('fonts/UnitedSansReg-Black.woff')
        ...
        for (var player of data) {
          ...
          var image_buffer = await nodeHtmlToImage({
            ...
            <head>
              ...
              <link rel="preload" href="fonts/UnitedSansReg-Black.woff" as="font" type="font/woff" crossorigin>
              <link rel="preload" href="fonts/UnitedSansReg-Heavy.woff" as="font" type="font/woff" crossorigin>
              ...
              @font-face {
                ...
                src: url(${united_sans_reg_black}) format('woff'); // don't forget the format!
              }

              @font-face {
                font-family: 'United Sans Reg Heavy';
                src: url(${united_sans_reg_heavy}) format('woff'); // don't forget the format!
              }
